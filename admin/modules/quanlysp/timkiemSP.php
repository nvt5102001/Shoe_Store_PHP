<?php
  ...
  {
        $sql_lietke_sp = "SELECT * FROM tblsanpham,tblthuonghieu,tblloaisp WHERE tblsanpham.IdTH = tblthuonghieu.IdTH and tblsanpham.IdLoaiSP = tblloaisp.IdLoaiSP AND tblsanpham.TenSP LIKE '%".$tukhoa."%' ORDER BY IdSP DESC";
	    $query_lietke_sp = mysqli_query($mysqli,$sql_lietke_sp);
  }
                      ...
                      <?php
                        ...
                        <td >
                          <div style="display:flex;align-items:center;">
                            <a href="modules/quanlysp/xuly.php?IdSP=<?php echo $row['IdSP'] ?>">
