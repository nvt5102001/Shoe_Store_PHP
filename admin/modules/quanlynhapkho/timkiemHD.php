<?php
  ...
  if($tukhoa != " ")
  {
    $sql_lietke_pnk = "SELECT * FROM tblphieunk,tbltaikhoan WHERE tblphieunk.GmailNCC=tbltaikhoan.Gmail AND tblphieunk.ThoiGian LIKE '%".$tukhoa."%' ORDER BY tblphieunk.IdPNK DESC";
