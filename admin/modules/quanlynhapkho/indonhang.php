<?php
	...
	$code = $_GET['code'];
	$sql_lietke_dh = "SELECT * FROM tblchitietpnk,tblsanpham WHERE tblchitietpnk.IdSP=tblsanpham.IdSP AND tblchitietpnk.IdPNK='".$code."' ORDER BY tblchitietpnk.IdCTPNK DESC";
	...
	$pdf->Cell($width_cell[1],10,$row['IdPNK'],1,0,'C',$fill);
	...
	$pdf->Cell($width_cell[5],10,number_format($row['SoLuongNhap']*$row['GiaBan']),1,1,'C',$fill);
	$fill = !$fill;
