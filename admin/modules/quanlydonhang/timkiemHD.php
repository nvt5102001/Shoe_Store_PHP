<?php
  ...
  if($tukhoa != " ")
  {
    $sql_lietke_dh = "SELECT * FROM tbldondat,tbltaikhoan WHERE tbldondat.GmailKH=tbltaikhoan.Gmail AND tbldondat.ThoiGian LIKE '%".$tukhoa."%' ORDER BY tbldondat.IdDD DESC";
